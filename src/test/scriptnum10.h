...
#ifndef KORI_TEST_SCRIPTNUM10_H
#define KORI_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Kori Core 0.10.0, for cross-comparison.
 */
public:
