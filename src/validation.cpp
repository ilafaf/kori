...
#if defined(NDEBUG)
# error "Kori cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Kori Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s KOR additional fees, %d delta bytes\n",
