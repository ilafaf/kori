...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/kori/kori/pull/10340, but that change has been
    // postponed until after https://github.com/kori/kori/pull/10244 to
                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    unsigned int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-kori-address
 ...
 * https://koritalk.org/?topic=54527, or
 * https://github.com/kori/kori/pull/1393.
 */
