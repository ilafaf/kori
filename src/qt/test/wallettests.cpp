...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<KoriAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_kori-qt -platform xcb      # Linux
//     src/qt/test/test_kori-qt -platform windows  # Windows
//     src/qt/test/test_kori-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = KoriUnits::formatWithUnit(unit, balance, false, KoriUnits::separatorAlways);
    ...
    // Amount input
    KoriAmountField* amountInput = receiveCoinsDialog.findChild<KoriAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: kori:")) != -1);
