...
#ifndef KORI_QT_KORIUNITS_H
#define KORI_QT_KORIUNITS_H
...
/** Kori unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KoriUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KoriUnits(QObject *parent);

    /** Kori units.
      @note Source: https://en.kori.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KOR,
...
typedef KoriUnits::Unit KoriUnit;

#endif // KORI_QT_KORIUNITS_H
