...
# TestNode: A peer we use to send messages to korid, and store responses.
...
class CompactBlocksTest(KoriTestFramework):
    ...
    # This test actually causes korid to (reasonably!) disconnect us, so do this last.
    ...
    # Test that korid requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for korid to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # korid will not send blocktxn responses for blocks whose height is
