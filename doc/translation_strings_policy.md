...
This document provides guidelines for internationalization of the Kori Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kori_en.ts` remains unchanged.
