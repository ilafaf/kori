Kori Core version 0.10.4 is now available from:

  <https://kori.org/bin/kori-core-0.10.4/>
...
- #6953 `43c2789` Split kori-tx into its own package
- #6953 `dfe0d4d` Include kori-tx binary on Debian/Ubuntu
