Kori-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/kori/files/Kori/kori-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Kori
...
New/changed settings (command-line or kori.conf file)
--------------------------------------------------------
