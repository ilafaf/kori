Kori Core version 0.9.4 is now available from:

  https://kori.org/bin/0.9.4/
...
this update is incompatible with the Kori system and could lead to consensus
forks.

Kori Core released binaries from https://kori.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~kori/+archive/ubuntu/kori
- A third-party or self-compiled Kori Core

upgrade to Kori Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
