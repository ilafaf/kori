Kori Core version 0.13.2 is now available from:

  <https://kori.org/bin/kori-core-0.13.2/>
...
- #8908 `4a974b2` Update kori-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow kori-tx to create v2 transactions (btcdrak)
