Download URL: https://sourceforge.net/projects/kori/files/Kori/kori-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 KOR fee schedule (users still pay 0.01 KOR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #kori00 - #kori99
