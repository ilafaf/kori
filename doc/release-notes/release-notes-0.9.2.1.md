Kori Core version 0.9.2.1 is now available from:

  https://kori.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 KOR to 0.01 KOR
...
- Fix "Start kori on system login"
