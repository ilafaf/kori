Kori version 0.5.4 is now available for download at:
http://sourceforge.net/projects/kori/files/Kori/kori-0.5.4/
...
http://gitorious.org/kori/korid-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Kori-Qt notifications under Growl 1.3.
Increase required age of Kori-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxKori properly when installing Kori-Qt over it. (Windows)
