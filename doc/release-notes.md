...
Kori Core version *version* is now available from:

  <https://kori.org/bin/kori-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile Kori Core is now 4.8. No effort will be
